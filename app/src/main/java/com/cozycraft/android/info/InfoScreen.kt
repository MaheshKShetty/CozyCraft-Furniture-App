package com.cozycraft.android.info
...
fun InfoScreen(modifier: Modifier = Modifier, navHostController: NavHostController) {
    ...
    Column(modifier = modifier.fillMaxSize()) {
        Scaffold(
            ...
            Column(modifier = modifier.fillMaxSize().padding(innerPadding).align(Alignment.CenterHorizontally), verticalArrangement = Arrangement.Center) {
                Image(
